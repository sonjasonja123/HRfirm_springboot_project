...
const CompanyLogin = () => {
    ...
    useEffect(() => {
        if (authService.isAuthenticated() && authService.getUserType() === 'company') {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await authService.loginCompany(username, password);
                ...
                <Card className="shadow-lg" style={{ backgroundColor: 'rgba(255, 255, 255, 0.95)' }}>
                    ...
                    <Card.Body className="p-4">
                        ...
                        <div className="mt-3 text-muted text-center">
                            <small>Test nalog: techsolutions / tech123</small>
                        </div>
                    </Card.Body>
                </Card>
            </Container>
